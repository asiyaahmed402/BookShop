...
import java.util.*;
/**
 * This is the BusinessFooter class
 * which has two methods
 * @exception IOException
 */

public class BusinessFooter extends FooterAbstractClass {
    ...
    public void LegalDisclaimer() throws IOException {
        ...
        try (Scanner s = new Scanner(new FileReader("src\\main\\java\\edu\\bu\\met\\cs665\\FooterPackage\\EmployeeLiability"))) {
            while (s.hasNext()) {
