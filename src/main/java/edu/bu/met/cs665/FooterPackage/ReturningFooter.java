...
public class ReturningFooter extends FooterAbstractClass {
    /**
    ...
    public void LegalDisclaimer() throws IOException {
        ...
        try (Scanner s = new Scanner(new FileReader("src\\main\\java\\edu\\bu\\met\\cs665\\FooterPackage\\NewsLetterFooter"))) {
            while (s.hasNext()) {
