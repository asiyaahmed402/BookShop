...
/**
 * This class is the body of the business entity email
 * @exception Exception
 */


public class BusinessBody extends EmailBody {
    /**
    ...
    public void readEmailBody() throws Exception{
        Scanner sc = new Scanner(new File("src\\main\\java\\edu\\bu\\met\\cs665\\MainBodyPackage\\BusinessText"));
        while(sc.hasNext()){
    ...
    public void encryptBodyOfEmail() throws Exception {
        ...
        FileInputStream inFile = new FileInputStream("src\\main\\java\\edu\\bu\\met\\cs665\\MainBodyPackage\\BusinessText");
