...
import java.util.*;
/**
 * This class is the body of the returning customer entity email
 * @exception Exception
 */
public class ReturningEmailBody extends EmailBody {
    /**
    ...
    public void readEmailBody() throws Exception{
        Scanner sc = new Scanner(new File("src\\main\\java\\edu\\bu\\met\\cs665\\MainBodyPackage\\ReturningText"));
        while(sc.hasNext()){
    ...
    public void encryptBodyOfEmail() throws Exception {
        ...
        FileInputStream inFile = new FileInputStream("src\\main\\java\\edu\\bu\\met\\cs665\\MainBodyPackage\\ReturningText");
