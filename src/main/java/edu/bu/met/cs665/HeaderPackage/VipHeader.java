...
/**
 * This is vip customer header class has three methods
 * @exception IOException
 */
public class VipHeader extends EmailHeader {
    /**
    ...
    public void generateNames() throws IOException {
        ...
        try (Scanner s = new Scanner(new FileReader("src\\main\\java\\edu\\bu\\met\\cs665\\HeaderPackage\\ExecutiveTeam"))) {
            while (s.hasNext()) {
