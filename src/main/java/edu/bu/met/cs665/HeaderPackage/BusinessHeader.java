...
/**
 * This is business header class has three methods
 * @exception IOException
 */

public class BusinessHeader extends EmailHeader {
    /**
    ...
    public void generateNames() throws IOException {
        ...
        try (Scanner s = new Scanner(new FileReader("src\\main\\java\\edu\\bu\\met\\cs665\\HeaderPackage\\MarketingTeam"))) {
            while (s.hasNext()) {
